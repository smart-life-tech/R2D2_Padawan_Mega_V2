...
void loop()
{
  ...
  if (Xbox.getButtonPress(L1, 0) && (Xbox.getButtonPress(DOWN, 0)))
  {
    pwm1.setPWM(5, 0, UpperUtilIn);
    pwm1.setPWM(4, 0, LowerUtilIn);
  }

  else if (Xbox.getButtonPress(L1, 0) && (Xbox.getButtonPress(UP, 0)))
  {
  ...
  if (Xbox.getButtonPress(R2, 0) && (Xbox.getButtonPress(LEFT, 0)))
  {
  ...
  // HoloProjector animation
  if (Xbox.getButtonPress(UP, 0) && (Xbox.getButtonPress(L2, 0)))
  {
    HoloPWMstart = 4;
    HoloAni1a = 1000;
  }
  ...
  // HoloProjector animation
  if (Xbox.getButtonPress(DOWN, 0) && (Xbox.getButtonPress(L2, 0)))
  {
    HoloPWMstart = 8;
    HoloAni1a = 1000;
  }
